...
def main():
    ...
    for data_name in tqdm.tqdm(data_names):
        ...
        for index in random.sample(range(len(train_datasets["train"])), 3):
            logger.info(f"Prompt sample {index} of the raw training set:\n\n{train_datasets['train'][index]['prompt']}")
            logger.info(f"Chosen sample {index} of the raw training set:\n\n{train_datasets['train'][index]['chosen']}")
            logger.info(f"Rejected sample {index} of the raw training set:\n\n{train_datasets['train'][index]['rejected']}")
        ...
        metrics["train_samples"] = len(train_datasets["train"])
        ...
        if training_args.do_eval:
            ...
            metrics["eval_samples"] = len(test_datasets["train"])
